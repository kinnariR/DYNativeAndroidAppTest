 ...
 */
class CommentAdapter(private val commentList: MutableList<CommentData>, private val onItemClick: (mData: CommentData) -> Unit) :
        ...
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                val data = if (charSearch.isEmpty()) {
                    ...
                    val resultList =
                        commentList.filter { it.comment.lowercase().contains(charSearch, true) || it.name.lowercase().contains(charSearch,true) }
                            .toMutableList()
                    resultList
                }
